...
public class UpdateTeacherActivity extends AppCompatActivity {
    ...
    private String downloadUri, category, uniqueKey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
          //  Picasso.get().load(image).into(updateTeacherImage);
            Glide.with(this).load(image).into(updateTeacherImage);
        } catch (Exception e) {
            e.printStackTrace();
        }
       ...
       reference.child(category).child(uniqueKey).removeValue()
              .addOnCompleteListener(new OnCompleteListener<Void>() {
                  @Override public void onComplete(@NonNull Task<Void> task) {
                      pd.dismiss();
                      Toast.makeText(UpdateTeacherActivity.this, "Teacher Deleted Update successfully", Toast.LENGTH_SHORT).show();
